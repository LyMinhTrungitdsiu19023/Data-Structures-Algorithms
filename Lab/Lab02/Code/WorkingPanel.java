 ...
 */
package DSA2020_GUI.src.dsa2020;
...
public class WorkingPanel extends JPanel
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        String message = String.format("mouseDragged: Device(x,y)=(%d,%d); Logic(x,y)=(%6.2f, %6.2 f)", e.getX(),
                e.getY(), logPoint.getX(), logPoint.getY());
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        } else if (e.getSource() == MainFrame.graph) {
            sin = Graph.sin(0.5, -50, 0.5, 0.05);
            quad = Graph.quadratic(1, 0, 0, -50, 50, 0.05);
            this.repaint();
        }
    }
